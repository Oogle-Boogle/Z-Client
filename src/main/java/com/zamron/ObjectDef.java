...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		if (i == 359) {
			objectDef.name = "Easy Scavenge Box";
			objectDef.actions[1] = "Scavenge box";
		}
		if (i == 360) {
			objectDef.name = "Medium Scavenge Box";
			objectDef.actions[1] = "Scavenge box";
		}
		if (i == 361) {
			objectDef.name = "Hard Scavenge Box";
			objectDef.actions[1] = "Scavenge box";
		}
		if (i == 2466) {
		...
		if (i == 12131) { //Boss Minigame Stairs
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Enter Boss Arena";
		}
		if (i == 4126) { //Boss Minigame Chest
			objectDef.actions = new String[5];
		...
		if (i == 9075) {
			objectDef.name = "@cya@Uber Bank Chest";
			objectDef.hasActions = true;
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Access";
		}
		...
		if (i == 54587) {
			objectDef.name = "@cya@Raids Chest@whi@(Easy)";
