	...
	public void actionPerformed(ActionEvent evt) {
		...
		try {
			if (cmd != null) {
				switch (cmd) {
				case "Home":
					openURL("https://zamron.us");
					break;
				case "Forum":
					openURL("https://zamron.us/forums");
					break;
				case "Guides":
					openURL("https://zamron.us/forums/forumdisplay.php?fid=20");
					break;
				case "Store":
					openURL("https://zamron.us/store");
					break;
				case "Vote":
					openURL("https://zamron.us/vote");
					break;
				case "HiScores":
					openURL("https://zamron.us");
					break;
				case "Join Discord":
					...
					// "ForumGuest";
					openURL("https://discord.gg/CeHjENEfVv");
					break;
				}
