...
public final class Skills {
    ...
    public static final int SKILL_COUNT = 27;
    ...
    public static String[] SKILL_NAMES = {
        ...
        "Dungeoneering", "PVM", "Scavenging"
    };
    
    public static int SKILL_ID(int ids) {
		int[] hoverIds = { 4040, 4076, 4112, 4046, 4082, 4118, 4052, 4088, 4124, 4058, 4094, 4130, 4064, 4100, 4136, 4070, 4106, 4142, 4160, 2832, 13917, 28173, 28174, 28175, 28176, 28192, 28200 };
    ...
    // if you want what i can do is restart it all again the hole code on rsinteface?
    ...
    public static int SKILL_ID_NAME(String name) {
        ...
        int[] skillID = {
            0, 3, 14, 2, 16, 13, 1, 15, 10, 4, 17, 7, 5, 12, 11, 6, 9, 8, 20, 18, 19, 21, 22, 23, 24, 25 ,26, 27
        };
        String[] names = {
            "Attack", "Constitution", "Mining", "Strength", "Agility",
            "Smithing", "Defence", "Herblore", "Fishing", "Ranged", "Thieving",
