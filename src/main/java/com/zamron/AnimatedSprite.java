...
public final class AnimatedSprite extends Sprite {
	...
	@Override
	public void block_copy_mask(int[] src, int scanSize, byte[] dir, int height, int dst[], int tmp, int dstOff,
	...
	public void setScaleDetail(int scaleDetail) {
		if (scaleDetail != SCALE_DETAIL_DEFAULT && scaleDetail != SCALE_DETAIL_QUALITY
				&& scaleDetail != SCALE_DETAIL_SPEED)
