...
public final class Stream extends QueueNode {
	...
	public void writeWordBigEndian(int i) { /// writes a byte
		buffer[currentOffset++] = (byte) i;
	}

	public void writeWord(int i) { // writes a short packet
	...
	public void writeDWordBigEndian(int i) { // writes 3 bits, dunno wtf i shud name it to lol
		buffer[currentOffset++] = (byte) (i >> 16);
		buffer[currentOffset++] = (byte) (i >> 8);
		buffer[currentOffset++] = (byte) i;
	}

	public void writeDWord(int i) { // writes a int packet
	...
	public void writeQWord(long l) { // writes a long packet
		try {
