...
final class ObjectManager {
	...
	// public List<Integer> floDump = new ArrayList<>();
		...
		for (int l = 0; l < 4; l++) {
			...
			for (int l6 = -5; l6 < anInt146 + 5; l6++) {
				...
				if (l6 >= 1 && l6 < anInt146 - 1) {
					...
					for (int k17 = -5; k17 < anInt147 + 5; k17++) {
						...
						if (k17 >= 1 && k17 < anInt147 - 1 && (!(lowMem) || (tileSettings[0][l6][k17] & 2) != 0
								|| (tileSettings[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6) == anInt131)) {
							if (l < highestPlane) {
								highestPlane = l;
							}
							...
							if (l18 > 0 || i19 > 0) {
								...
								if (l > 0) {
									boolean flag = true;
									if (l18 == 0 && overlayClippingPaths[l][l6][k17] != 0) {
										flag = false;
									}
									if (i19 > 0 && !OverlayFloor.overlayFloors[i19 - 1].aBoolean393) {
										flag = false;
									}
								...
								int i22 = 0;
								if (j21 != -1) {
									i22 = Rasterizer.anIntArray1482[getShadow(k21, 96)];
								}
								if (i19 == 0) {
									worldController.method279(l, l6, k17, 0, 0, -1, 154, j19, k19, l19, i20,
											getShadow(j21, j20), getShadow(j21, k20), getShadow(j21, l20),
											getShadow(j21, i21), 0, 0, 0, 0, i22, 0, false);
								} else {
									int k22 = overlayClippingPaths[l][l6][k17] + 1;
									byte byte4 = overlayClippingPathRotations[l][l6][k17];
									if (i19 - 1 > OverlayFloor.overlayFloors.length) {
										i19 = OverlayFloor.overlayFloors.length;
									}
									OverlayFloor flo_2 = OverlayFloor.overlayFloors[i19 - 1];
									...
									// if (floorTexture == 47) {
									// mapTexture = Rasterizer.method369(51);
									// j23 = -1;
									// }

									if (floorTexture >= 0 && floorTexture <= Rasterizer.textureAmount) {
									...
									worldController.method279(l, l6, k17, k22, byte4, floorTexture, 154, j19, k19, l19,
											...
											getShadow(j21, i21), getOverlayShadow(j23, j20), getOverlayShadow(j23, k20),
											getOverlayShadow(j23, l20), getOverlayShadow(j23, i21), i22, mapTexture,
											floorTexture >= 0 && floorTexture <= Rasterizer.textureAmount);
								}
							}
						}
					}
			...
			for (int j8 = 1; j8 < anInt147 - 1; j8++) {
				for (int i10 = 1; i10 < anInt146 - 1; i10++) {
					worldController.setVisiblePlanesFor(l, i10, j8, method182(j8, l, i10));
				}
					...
					for (int i4 = 0; i4 <= anInt146; i4++) {
						if ((anIntArrayArrayArray135[i3][i4][k3] & i2) != 0) {
							...
							if (l10 >= 8) {
								...
								WorldController.createCullingCluster(l2, i4 * 128, l15, i4 * 128, l5 * 128 + 128, k14,
										k4 * 128, 1);
						...
						if ((anIntArrayArrayArray135[i3][i4][k3] & j2) != 0) {
							...
							if (k11 >= 8) {
								...
								WorldController.createCullingCluster(l2, l4 * 128, i16, i6 * 128 + 128, k3 * 128, l14,
										k3 * 128, 2);
						...
						if ((anIntArrayArrayArray135[i3][i4][k3] & k2) != 0) {
							...
							if ((j6 - i5 + 1) * (i9 - k7 + 1) >= 4) {
								...
								WorldController.createCullingCluster(l2, i5 * 128, j12, j6 * 128 + 128, i9 * 128 + 128,
										j12, k7 * 128, 4);
	...
	public void method175(int y, WorldController worldController, CollisionDetection class11, int j, int z, int x,
			int i1, int j1) {
		try {
			...
			if (j == 10 || j == 11) {
				...
				if (obj1 != null) {
					...
					if (worldController.addInteractableEntity(l2, byte0, k2, l4, ((Animable) (obj1)), j4, z, i5, y, x,
							i1) && objectDef.aBoolean779) {
						Model model;
			...
			if (j == 0) {
				...
				worldController.addWallObject(anIntArray152[j1], ((Animable) (obj3)), l2, y, byte0, x, null, k2, 0, z,
						i1);
				if (j1 == 0) {
			...
			if (j == 1) {
				...
				worldController.addWallObject(anIntArray140[j1], ((Animable) (obj4)), l2, y, byte0, x, null, k2, 0, z,
						i1);
				if (objectDef.aBoolean779)
					if (j1 == 0)
						aByteArrayArrayArray134[z][x][y + 1] = 50;
			...
			if (j == 2) {
				...
				worldController.addWallObject(anIntArray152[j1], ((Animable) (obj11)), l2, y, byte0, x,
						((Animable) (obj12)), k2, anIntArray152[i3], z, i1);
				if (objectDef.aBoolean764)
					if (j1 == 0) {
						anIntArrayArrayArray135[z][x][y] |= 0x249;
						anIntArrayArrayArray135[z][x][y + 1] |= 0x492;
			...
			if (j == 3) {
				...
				worldController.addWallObject(anIntArray140[j1], ((Animable) (obj5)), l2, y, byte0, x, null, k2, 0, z,
						i1);
				if (objectDef.aBoolean779)
					if (j1 == 0)
						aByteArrayArrayArray134[z][x][y + 1] = 50;
			...
			if (j == 4) {
				...
				worldController.addWallDecoration(l2, y, j1 * 512, z, 0, k2, ((Animable) (obj7)), x, byte0, 0,
						anIntArray152[j1], i1);
				return;
			}
			if (j == 5) {
				...
				worldController.addWallDecoration(l2, y, j1 * 512, z, anIntArray137[j1] * i4, k2, ((Animable) (obj13)),
						x, byte0, anIntArray144[j1] * i4, anIntArray152[j1], i1);
				return;
			}
			if (j == 6) {
				Object obj8;
	...
	public final void loadMapChunk(int reqPlane, int rotation, CollisionDetection clips[], int baseX,
			int baseTileXChunk, byte mapData[], int baseTileYChunk, int myPlane, int baseY) {
		/**
		 * Apply clipping
		 */
		...
		for (int plane = 0; plane < 4; plane++) {
			for (int xTile = 0; xTile < 64; xTile++) {
				for (int yTile = 0; yTile < 64; yTile++)
					if (plane == reqPlane && xTile >= baseTileXChunk && xTile < baseTileXChunk + 8
							&& yTile >= baseTileYChunk && yTile < baseTileYChunk + 8)
						readTile(baseY + MapUtility.getRotatedMapChunkY(yTile & 7, rotation, xTile & 7), 0, stream,
								baseX + MapUtility.getRotatedMapChunkX(rotation, yTile & 7, xTile & 7), myPlane,
								rotation, 0);
					else
	...
	private void readTile(int tileY, int j, Stream stream, int tileX, int tilePlane, int rotation, int k1) {
	...
	public final void readObjectMap(CollisionDetection clippingPlanes[], WorldController worldController, int myPlane,
			int baseXTile, int baseYTileShifted, int reqPlane, byte mapData[], int baseXTileShifted, int rotation,
			int baseYTile) {
		label0: {
			...
			do {
				...
				do {
					...
					if (objectPlane == myPlane && objectTileX >= baseXTileShifted && objectTileX < baseXTileShifted + 8
							&& objectTileY >= baseYTileShifted && objectTileY < baseYTileShifted + 8) {
						ObjectDef objectDef = ObjectDef.forID(foundObjectId);
						int finalXTile = baseXTile + MapUtility.getRotatedLandscapeChunkX(rotation,
								(objectRotation == 0 || objectRotation == 2) ? objectDef.sizeY : objectDef.sizeX,
								objectTileX & 7, objectTileY & 7,
								(objectRotation == 0 || objectRotation == 2) ? objectDef.sizeX : objectDef.sizeY);
						int finalYTile = baseYTile + MapUtility.getRotatedLandscapeChunkY(objectTileY & 7,
								(objectRotation == 0 || objectRotation == 2) ? objectDef.sizeY : objectDef.sizeX,
								rotation,
								(objectRotation == 0 || objectRotation == 2) ? objectDef.sizeX : objectDef.sizeY,
								objectTileX & 7);
						if (finalXTile > 0 && finalYTile > 0 && finalXTile < 103 && finalYTile < 103) {
							...
							method175(finalYTile, worldController, tileSetting, type, reqPlane, finalXTile,
									foundObjectId, objectRotation + rotation & 3);
						}
					}
				} while (true);
			} while (true);
	...
	public static void method188(WorldController worldController, int i, int j, int k, int l,
			CollisionDetection class11, int ai[][][], int i1, int j1, int k1) {
		int l1 = ai[l][i1][j];
		int i2 = ai[l][i1 + 1][j];
		...
		if (k == 2) {
			...
			worldController.addWallObject(anIntArray152[i], ((Animable) (obj11)), i3, j, byte1, i1,
					((Animable) (obj12)), l2, anIntArray152[j3], k1, j1);
			if (class46.isUnwalkable)
				class11.method211(j, i, i1, k, class46.aBoolean757);
			return;
		}
		...
		if (k == 4) {
			...
			worldController.addWallDecoration(i3, j, i * 512, k1, 0, l2, ((Animable) (obj7)), i1, byte1, 0,
					anIntArray152[i], j1);
			return;
		}
		if (k == 5) {
			...
			worldController.addWallDecoration(i3, j, i * 512, k1, anIntArray137[i] * j4, l2, ((Animable) (obj13)), i1,
					byte1, anIntArray144[i] * j4, anIntArray152[i], j1);
			return;
		}
		if (k == 6) {
			Object obj8;
	...
	public final void method190(int i, CollisionDetection aclass11[], int j, WorldController worldController,
			byte abyte0[]) {
		label0: {
